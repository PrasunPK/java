...
public class DecorationTest {
    ...
    public void test_decorateAll_decorates_given_guests_in_an_array_and_returns_the_decorated_strings() throws Exception {
        ...
        Guest g2 = new Guest(new Name("Brandt", "Huel"), "Male", 25, new Address(new City("West Shanna"), new State("Illinois"), new Country("Macedonia")));
        Guest g3 = new Guest(new Name("Velma", "Bergstrom"), "Female", 24, new Address(new City("Katlynn view"), new State("Vermont"), new Country("Macedonia")));
